        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              ...
              Container(
                  padding: const EdgeInsets.all(8.0), child: Text('Dr. Cough'))
            ],
        ...
        body: ListView(
          children: <Widget>[
            Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Text( 'An app by AI4Networks\nPlease record your cough and tap on predict button',
                      style: TextStyle(
                      fontSize: 15.0,
                      color: Colors.black,
                    ),
            ...
            Column(
              ...
              children: <Widget>[
                Container(
                  margin: EdgeInsets.only(top: 40.0, bottom:16.0),
                  child: Text(
                    this._playerTxt,
                    style: TextStyle(
                      fontSize: 40.0,
            ...
            Container(
              height: 76.0,
              child: new ButtonBar(alignment: MainAxisAlignment.center,
                children: <Widget>[
                  new InkWell(
                    onTap: () {
                      showDialog(
                    ...
                    child: new Container(
                      ...
                      child: new Center(child: new Text(' PREDICT ', style: new TextStyle(fontSize: 22.0, color: Colors.white),),),
                    ),
                  ),
                ],
